...
export async function PATCH(
  ...
  // ✅ Undo seguro: scheduled desde late o no_show
  ...
  // ✅ No permitir no_show en futuras
  ...
  // Cancel: set cancelled_at + limpiar
  ...
  // No-show: set detected_at + pending según settings / excused
  if (nextStatus === "no_show") {
